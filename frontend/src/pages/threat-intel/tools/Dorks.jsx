...
export default function Dorks({ onResult, onError, onLoading }) {
  ...
  return (
    <section className="group md:col-span-2 border border-[rgba(0,255,65,0.12)] bg-[linear-gradient(160deg,rgba(0,255,65,0.05),rgba(13,13,13,0.97)_65%)] p-4 flex flex-col gap-4 transition duration-200 hover:border-[rgba(0,255,65,0.32)]">
